...
const App = () => {
  return (
    <div className='parent'>
      ...
      <Card user='Satyam kesari' age={21} img='https://images.unsplash.com/photo-1769454842761-844bb862e92a?w=600&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwyN3x8fGVufDB8fHx8fA%3D%3D' />
    </div>
  )
}
